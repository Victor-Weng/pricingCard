'''
Instagram bot for the account "dreamhomes.ai." This program will call an api to StableDiffusion
...
negative_prompt = "ugly, bad, bad lighting, portrait, poorly drawn, blury, morphed, disfigured, weird, odd, unfocused, illegal" # stuff to avoid
...
SAVE_PATH = r"c:/Users/Victo/OneDrive/Desktop/pythonCode/Dreamhomesai/imgs"
image_paths = [] # list for all the iamge paths
...
def generate_image(prompt):
    ...
    prompt1 = "A single 1:1 dimension exterior photo of" + prompt + positive_prompt
    ...
    # then generate images of the interior

    prompt2 = "A single 1:1 dimension interior/room photo of" + prompt + positive_prompt
